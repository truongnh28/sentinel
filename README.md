...
**3 hoàn thành · 1 làm theo hướng khác · 7 một phần · 0 chưa bắt đầu** (11 stage, 0–10). Rà soát ngày 22/09 bằng cách đọc mã và chạy lại toàn bộ test; cập nhật 23/09 sau đợt đo W1–W6, và **24/09 sau khi sửa thang chi phí, giá cách ly, ngân sách theo chân trời, rồi rà lại toàn repo** ([runbook](docs/AuditGame-SE_Parameter_Measurement_Runbook.md)). Đợt rà cuối ngày 24/09 đưa **Stage 7 lên hoàn thành** (hai ví dụ tay thành test) và đổi *nội dung* của Stage 2, 3, 6 và 9 — chi tiết trong cột Issue.

Một stage chỉ lên ✅ khi cột Issue không còn việc mở. Bảy stage 🟡 còn lại đều có ít nhất một việc mở ghi rõ ở cột cuối, và phần lớn chúng chờ **một quyết định** (#13, T1) hoặc **mốc 29/09**, không chờ một phép đo.
...
| 10 | 🟡 Một phần | LP Stackelberg (Conitzer–Sandholm); ranh giới tuning qua tiền đăng ký; **double oracle** trên 240 game nhỏ | Double oracle thêm 40 nghiệm: $\rho$ 0,750 → 0,500, regret trung bình 0,0280 → 0,0219, **max regret y nguyên 0,3333** | Double oracle đã chạy, và nó **không** là phương thuốc: khoảng cách không phải khoảng cách phủ |
