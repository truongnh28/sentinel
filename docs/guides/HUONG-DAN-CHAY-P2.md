...
- **Độ dài không còn được chọn tay, và từ 18/09 nó là RIÊNG TỪNG INSTANCE.** Xem [`docs/preregistration/p2-ngan-sach-loi-khuyen.md`](../preregistration/p2-ngan-sach-loi-khuyen.md) và `spikes/p2_budget.py`:
