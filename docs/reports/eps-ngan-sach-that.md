...
Ngày: 2026-09-17. Nối tiếp `chot_theta.md` (chốt θ) và `docs/preregistration/ho-tan-cong-mo-rong.md`
...
2. **`DistributionMatchedAttack` mang ĐÚNG khuyết tật §2 và tài liệu này KHÔNG
   ...
   công bố ở `docs/preregistration/ho-tan-cong-mo-rong.md`, và sửa nó sẽ làm dịch bảng đó.
